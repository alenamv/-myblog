...
if (isset($_POST['nazvanie']) and isset($_POST['avtor']) and isset($_POST['sozdanie']) and isset($_POST['text'])) {
    ...
    $sql = "INSERT INTO articles (`nazvanie`, `avtor`, `sozdanie`, `text`) VALUES ('$nazvanie', '$avtor', '$sozdanie', '$text')";
    $mysql->query($sql);
    $mysql->close();
    header('Location: /');
}
        ...
        <div class="col-lg-4 offset-lg-4 mt-4">
            <form action="" method="post" id="sozdatArticle">
                ...
                <label class="w-100" for="">
                    Название<br>
                    <input class="form-control" type="text" name="nazvanie" placeholder="Название" required>
                </label>
                <label class="w-100" for="">
                     Автор<br>
                    <input class="form-control" type="text" name="avtor" placeholder="Автор" required>
                </label>
                <label class="w-100" for="">
                    Дата создания<br>
                    <input class="form-control" type="date" name="sozdanie" required>
                </label>
                <label class="w-100" for="">
                    Текст<br>
                    <textarea class="form-control" name="text" placeholder="Текст" rows="10" required></textarea>
                </label>
